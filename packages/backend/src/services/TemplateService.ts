...
const PRESET_TEMPLATES: CreateTemplateInput[] = [
  ...
  // ==================== 模板 2：现代都市恋爱 ====================
  {
    ...
    uiLayout: {
      ...
      customLayout: 'visual_novel',
    },
    numericalComplexity: 'simple',
    specialRules: {
      hasKP: false,
      permadeath: false,
      saveRestriction: '',
      customRules: ['好感度系统: 与NPC互动会影响好感度，好感度达到一定程度可解锁特殊剧情', '无永久死亡: 角色不会真正死亡，失败只会影响剧情走向'],
    },
  },
  ...
  // ==================== 模板 3：克苏鲁恐怖调查 ====================
  {
    ...
    uiLayout: {
      ...
      showSkillBar: false,
      showPartyPanel: false,
      customLayout: 'horror_investigation',
    },
    numericalComplexity: 'medium',
    specialRules: {
      hasKP: true,
      permadeath: true,
      saveRestriction: 'checkpoint',
      customRules: [
        'SAN值系统: 面对恐怖事物会损失理智，SAN值归零则角色永久疯狂',
        '知识代价: 学习禁忌知识会降低SAN值，但可能提供关键信息',
        '永久死亡: 角色死亡或疯狂后无法复活',
        '检查点存档: 只能在特定检查点存档',
      ],
    },
  ...
  // ==================== 模板 4：赛博朋克佣兵 ====================
  {
    ...
    uiLayout: {
      ...
      showSkillBar: true,
      showPartyPanel: true,
      customLayout: 'cyberpunk',
    },
    numericalComplexity: 'complex',
    specialRules: {
      hasKP: false,
      permadeath: false,
      saveRestriction: '',
      customRules: [
        '义体改造系统: 可以安装各种义体来增强能力，但过度改造会影响人性值',
        '网络入侵: 黑客可以在虚拟空间进行战斗，窃取数据或破坏系统',
        '声望系统: 与不同势力的关系会影响可接取的委托和获得的支援',
        '时间限制: 某些委托有时间限制，超时会导致失败',
      ],
    },
  },
];
